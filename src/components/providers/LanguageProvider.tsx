...
const translations: Record<Language, Translations> = {
  en: {
    ...
    getFreeIdrxDesc: "Claim 10,000 IDRX from testnet faucet",
    ...
    claimSuccess: "Successfully claimed 10,000 IDRX!",
    connectToClaim: "Connect Wallet to Claim",
    claiming: "Claiming...",
    confirming: "Confirming...",
    claimIdrx: "Claim 10,000 IDRX",
    ...
    faucetCooldown: "Get 10,000,000 IDRX free for testing. 24-hour cooldown.",
    claimIdrxAmount: "Claim 10,000,000 IDRX",
    links: "Links",
  ...
  id: {
    ...
    getFreeIdrxDesc: "Klaim 10.000 IDRX dari faucet testnet",
    aiYieldOptimizer: "AI Yield Optimizer",
    ...
    faucetCooldown: "Dapatkan 10.000.000 IDRX gratis untuk pengujian. Cooldown 24 jam.",
    claimIdrxAmount: "Klaim 10.000.000 IDRX",
    links: "Tautan",
